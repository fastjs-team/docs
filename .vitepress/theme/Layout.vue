...
import DocsModeSwitch from "./components/docsModeSwitch.vue";
...
<template>
  <div v-if="frontmatter.layout !== false" class="Layout" :class="{...frontmatter.pageClass, 'simple-mode': !advanceMode, 'advance-mode': advanceMode}">
